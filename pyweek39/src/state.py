...
def init():
    global homes, you, gettables, maxfuel, bank
    homes = [thing.Home()]
    you = thing.You((0, 0))
    gettables = []
    maxfuel = 8
...
def getstate():
    return grid.wind, grid.strength, homes, you, gettables, maxfuel, bank

def setstate(obj):
    global homes, you, gettables, maxfuel, bank
    grid.wind, grid.strength, homes, you, gettables, maxfuel, bank = obj
